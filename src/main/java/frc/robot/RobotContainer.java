...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain.applyRequest(() -> drive.withVelocityX(driver.getDriveForwardAxis() * MaxSpeed)
        ...
        driver.controller.b().whileTrue(drivetrain.applyRequest(() -> point
                .withModuleDirection(new Rotation2d(driver.getDriveForwardAxis(), driver.getDriveRotationAxis()))));

        driver.controller.povUp()
                .whileTrue(drivetrain.applyRequest(() -> forwardStraight.withVelocityX(0.5).withVelocityY(0)));
        driver.controller.povDown()
                .whileTrue(drivetrain.applyRequest(() -> forwardStraight.withVelocityX(-0.5).withVelocityY(0)));
